              ...
              {user ? (
                <>
                  <button
                    ...
                    className="flex-1 sm:flex-none bg-teal-600 text-white px-4 py-2 rounded-lg hover:bg-teal-700 transition text-sm disabled:opacity-50 disabled:cursor-not-allowed"
